...
export const PRIVACY_SAFE_ANSWER =
  "ขออภัยค่ะ ข้อมูลของลูกค้าท่านอื่นเป็นข้อมูลส่วนตัว ทางโรงแรมไม่สามารถเปิดเผยได้ค่ะ\n\nหากต้องการสอบถามข้อมูลการจองของคุณเอง สามารถแจ้งข้อมูลอ้างอิงการจองให้เจ้าหน้าที่ตรวจสอบได้ค่ะ";
...
// ในอนาคต อาจเพิ่มกฎอื่นๆ เช่น ห้ามให้ข้อมูลที่เป็นเท็จ ห้ามให้คำแนะนำที่อาจเป็นอันตราย ห้ามตอบคำถามที่อยู่นอกเหนือขอบเขตของโรงแรม เป็นต้น โดยสามารถสร้างฟังก์ชันตรวจสอบเพิ่มเติมในลักษณะเดียวกับฟังก์ชัน validateAiAnswer ได้ และต้องไม่พูโถึงโรงแรมอื่นๆในระบบการตอบคำถามของลูกค้า เพื่อป้องกันการให้ข้อมูลที่ไม่ถูกต้องหรือเป็นอันตรายแก่ลูกค้า และเพื่อรักษาความน่าเชื่อถือของโรงแรม //