...
export function buildAssistantSalesFlowInstruction(): string {
  return [
    ...
    "- When presenting promotions, proactively analyze the customer's booking details (guests, nights) to recommend the most suitable promotion first.",
    "- Suggest other promotions as an upsell ONLY if relevant (e.g., suggesting a longer stay for a better discount), without listing all promotions blindly.",
