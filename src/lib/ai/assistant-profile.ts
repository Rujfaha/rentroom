...
export function buildAssistantSalesFlowInstruction(): string {
  return [
    ...
    "- IMPORTANT: DO NOT ask the customer to choose a promotion. You MUST automatically select and apply the single most suitable promotion based on their details (guests, nights) and calculate the final price.",
